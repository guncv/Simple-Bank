...
// It create a transfer record, add account entries, and update account's balance within a simgle database transaction
...
func addMoney(ctx context.Context, q *Queries, accountID1 int64, accountID2 int64, amount int64) (account1 Account, account2 Account, err error) {
